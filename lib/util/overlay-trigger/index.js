...
var _overlayPositionUtils = require('react-overlays/lib/utils/overlayPositionUtils');
...
function adjustPosition(elem, getOverlayTarget, getOverlayContainer, position, alignment) {
  ...
  var targetPosition = (0, _overlayPositionUtils.getPosition)(target, container);
