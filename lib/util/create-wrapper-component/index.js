...
function createWrapperComponent() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$mapPropsToClassN = _ref.mapPropsToClassNames,
      mapPropsToClassNames = _ref$mapPropsToClassN === undefined ? function () {
    return {};
  } : _ref$mapPropsToClassN,
      _ref$mapPropsToStyle = _ref.mapPropsToStyle,
      mapPropsToStyle = _ref$mapPropsToStyle === undefined ? function () {
    return {};
  } : _ref$mapPropsToStyle,
      _ref$mapPropsToProps = _ref.mapPropsToProps,
      mapPropsToProps = _ref$mapPropsToProps === undefined ? function (props) {
    return props;
